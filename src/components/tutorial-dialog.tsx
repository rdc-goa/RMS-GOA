...
const tutorialSteps = {
  ...
  Evaluator: [
    {
      ...
      description: "Navigate to the 'Evaluation Queue' which contains tabs for both IMR projects and EMR presentations awaiting your review.",
    },
    {
      icon: History,
  ...
  admin: [
     {
      ...
      description: "From the 'All Projects' page, you can view, manage, and track every IMR and EMR project across the university.",
    },
    {
      icon: CalendarClock,
  ...
  CRO: [
    ...
    },
    {
      ...
      description: "You can be assigned as an evaluator for both IMR and EMR projects. Your assigned tasks will appear in the 'Evaluation Queue'.",
    },
    {
      icon: GraduationCap,
      title: 'Get Started',
  ...
  'Super-admin': [
    ...
    },
    {
      ...
      description: "Use 'Module Management' to dynamically grant or revoke access to any feature for any user, providing fine-grained permission control.",
    },
     {
      icon: Users,
